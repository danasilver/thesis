...
\begin{landscape}
  ...
  \begin{multicols}{2}
    ...
    \middguardcode{./middguard/views/graph-editor-template.jade}
    \middguardcode{./middguard/views/graphs-panel-template.jade}

    % \middguardcode{static/css/graph-editor.css}
  \end{multicols}
