...
the text and extracted entities. While MiddGuard is not a text based analytics
tool, of interest to us are the concepts that drive Jigsaw's views. Views are
coordinated and communicate with each other to update themselves. User
interaction with one view updates the others. Multiple copies can be created
from each view, each reflecting a different perspective of the data.

Improvise \cite{weaver-2004a}

Eagle Eyes \cite{7347662}
